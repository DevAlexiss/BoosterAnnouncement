...
<div class="col">
<div class="info-box">
        <p class="baslık">Booster Rolü Ver</p>
		<h5 class="i-text mt-4">Sadece Stafflara Özel Bölüm</h5>
		<input type="text" id="isimtext" name="isimtext" placeholder="Booster İsmi">
		<input type="submit" name="isim" value="Gönder">
        <h5 class="not mt-4">NOT: Boosterlara 5 Adet Duyuru Hakkı Verilir.</h5>
    </div>
</div>
</form>
						';
...
<div class="col">
    <div class="info-box">
        <p class="baslık">Booster Duyuru Yap</p>
        <h5 class="i-text mt-4">Kalan Hakkınız: <?php echo User::userData('boost') ?></h5>
		<input type="text" id="duyurutext" name="duyurutext" placeholder="Duyuru Yazısı">
		<input type="submit" name="duyuru" value="Gönder">
        <h5 class="not mt-4">NOT: Boosterların Oyun İçi Duyuru Yapmaları İçin Tasarlanmıştır.</h5>
    </div>
</div>
</form>
</div>
